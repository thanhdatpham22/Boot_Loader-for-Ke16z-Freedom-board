...
C_SRCS += \
../source/QUEUE/user_queue.c 

C_DEPS += \
./source/QUEUE/user_queue.d 

OBJS += \
./source/QUEUE/user_queue.o 


# Each subdirectory must supply rules for building sources it contributes
source/QUEUE/%.o: ../source/QUEUE/%.c source/QUEUE/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-QUEUE

clean-source-2f-QUEUE:
	-$(RM) ./source/QUEUE/user_queue.d ./source/QUEUE/user_queue.o

.PHONY: clean-source-2f-QUEUE
