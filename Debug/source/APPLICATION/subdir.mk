...
C_DEPS += \
./source/APPLICATION/app.d 

OBJS += \
./source/APPLICATION/app.o 


# Each subdirectory must supply rules for building sources it contributes
source/APPLICATION/%.o: ../source/APPLICATION/%.c source/APPLICATION/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-APPLICATION

clean-source-2f-APPLICATION:
	-$(RM) ./source/APPLICATION/app.d ./source/APPLICATION/app.o

.PHONY: clean-source-2f-APPLICATION
